...
- **有外貌身材**：每個人會生成身高、體型、髮型、眼睛、穿衣風格、記憶點特徵
  （女生含罩杯、男生含體格），寫進 SOUL.md，描述外觀/親密場景時依此設定；
  `intimacy_mode=off` 時自動省略較露骨的身材描述。
- **特殊屬性（抽卡稀有度）**：每人再抽 1~3 個香豔特殊屬性，分 ⚪普通／🔵稀有／🟣史詩／🌟傳說
  四級加權（如巨乳、白皙大長腿、巨大乳暈、藍/紅瞳…）；抽到史詩/傳說 `newOne` 會跳特效橫幅。
...
- **會復發、會被奪走**：原諒後再犯機率上升；忠誠太低會藕斷絲連；低階段更可能被情敵直接帶走離開。
